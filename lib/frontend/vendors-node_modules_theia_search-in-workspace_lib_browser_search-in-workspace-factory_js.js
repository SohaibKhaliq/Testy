"use strict";
(self["webpackChunktesty"] = self["webpackChunktesty"] || []).push([["vendors-node_modules_theia_search-in-workspace_lib_browser_search-in-workspace-factory_js"],{
...
let SearchInWorkspaceWidget = SearchInWorkspaceWidget_1 = class SearchInWorkspaceWidget extends browser_1.BaseWidget {
    constructor() {
        ...
        this.handleFocusSearchInputBox = (event) => {
            event.target.placeholder = `${SearchInWorkspaceWidget_1.LABEL} (⇅ ${nls_1.nls.localizeByDefault('for history')})`;
        ...
        this.handleFocusReplaceInputBox = (event) => {
            event.target.placeholder = `${nls_1.nls.localizeByDefault('Replace')} (⇅ ${nls_1.nls.localizeByDefault('for history')})`;
