(self["webpackChunktesty"] = self["webpackChunktesty"] || []).push([["vendors-node_modules_theia_callhierarchy_lib_browser_index_js-node_modules_theia_plugin-ext_l-547f93"],{
...
let WebviewWidget = WebviewWidget_1 = class WebviewWidget extends widget_1.BaseWidget {
    ...
    doShow() {
        ...
        this.toHide.push(this.on("onconsole" /* onconsole */, (data) => this.forwardConsoleLog(data)));
        ...
        this.toHide.push(this.on("did-context-menu" /* didcontextmenu */, (event) => {
