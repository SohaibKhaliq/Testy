(self["webpackChunktesty"] = self["webpackChunktesty"] || []).push([["vendors-node_modules_theia_plugin-ext_lib_hosted_browser_hosted-plugin_js"],{
...
__exportStar(__webpack_require__(/*! ./notebook-types */ "./node_modules/@theia/notebook/lib/browser/notebook-types.js"), exports);
        ...
        if (!manager) {
            ...
            await manager.$init({
                ...
                env: {
                    ...
                    appHost: isElectron ? 'desktop' : 'web',
                    appRoot
                },
                extApi,
                webview: {
...
HostedPluginSupport = HostedPluginSupport_1 = __decorate([
    (0, inversify_1.injectable)(),
    __metadata("design:paramtypes", [])
], HostedPluginSupport);
...
AbstractHostedPluginSupport = __decorate([
    (0, inversify_1.injectable)(),
...
class NotebooksAndEditorsMain {
    constructor(rpc, container, notebookDocumentsMain, notebookEditorsMain) {
        ...
        this.throttleStateUpdate = throttle((focusedEditor) => this.updateState(focusedEditor), 100);
